...
const subjects = [
  {
    ...
    course_id: "UTA002",
    course_site:
      "https://sites.google.com/a/thapar.edu/thapar-uta002-manufacturing-processes/home"
  },
  {
    ...
    <View>
      <View style={styles.opt}>
        ...
        <View style={{ paddingRight: 10 }}>
          ...
          >
            <Ionicons name="md-close-circle" size={32} />
          </TouchableHighlight>
        </View>
      </View>
      <Button
        ...
        full
        onPress={() => {
          Linking.openURL(this.state.site),
            this.toggleModal(!this.state.visibleModal);
        }}
      >
      ...
      <Button
        ...
        full
        onPress={() => {
          this.props.navigation.navigate("Prerequisites"),
            this.toggleModal(!this.state.visibleModal);
        }}
      >
      ...
      <Button
        ...
        full
        onPress={() => {
          this.props.navigation.navigate("FutureScope"),
            this.toggleModal(!this.state.visibleModal);
        }}
      >
              ...
              <View>
                <ListItem
                  onPress={() => {
                    ...
                    this.setState({ id: item.course_id });
                    this.setState({ site: item.course_site });
                  }}
                >
                  <Body>
